...
x,y = plotEvent(data,'100M','Men','G')
ax1.plot(x,y,label='Gold',c='#FFD700')
x,y = plotEvent(data,'100M','Men','S')
ax1.plot(x,y,label='Silver',c='#C0C0C0')
x,y = plotEvent(data,'100M','Men','B')
ax1.plot(x,y,label='Bronze',c='#CD7F32')

x,y = plotEvent(data,'100M','Women','G')
ax2.plot(x,y,label='Gold',c='#FFD700')
x,y = plotEvent(data,'100M','Women','S')
ax2.plot(x,y,label='Silver',c='#C0C0C0')
x,y = plotEvent(data,'100M','Women','B')
ax2.plot(x,y,label='Bronze',c='#CD7F32')

ax1.set(title='Men\'s 100m',ylabel='Time (s)')
ax1.legend()
ax2.set(title='Women\'s 100m',ylabel='Time (s)')
ax2.legend()
fig.tight_layout()
plt.show()