...
x,y = plotEvent(data,'10000M','Men','G')
ax1.plot(x,y,label='Gold',c='#FFD700')
x,y = plotEvent(data,'10000M','Men','S')
ax1.plot(x,y,label='Silver',c='#C0C0C0')
x,y = plotEvent(data,'10000M','Men','B')
ax1.plot(x,y,label='Bronze',c='#CD7F32')

x,y = plotEvent(data,'10000M','Women','G')
ax2.plot(x,y,label='Gold',c='#FFD700')
x,y = plotEvent(data,'10000M','Women','S')
ax2.plot(x,y,label='Silver',c='#C0C0C0')
x,y = plotEvent(data,'10000M','Women','B')
